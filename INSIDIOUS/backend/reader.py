...
nmap=reader("~/Desktop/report/output/Nmap.txt")
nslookup=reader("~/Desktop/report/output/nslookup.txt")
whois=reader("~/Desktop/report/output/whois.txt")
wpscanner=reader("~/Desktop/report/output/wpscanner.txt")
